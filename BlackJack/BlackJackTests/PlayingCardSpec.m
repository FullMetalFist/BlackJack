...
describe(@"FISPlayingCard", ^{
    ...
    beforeAll(^{
        myCard = [[FISPlayingCard alloc] initWithSuit:@"♠️" rank:@5];
    });
    ...
    describe(@"valid rank with designated initializer", ^{
        FISPlayingCard *myValidPlayingCard = [[FISPlayingCard alloc] initWithSuit:@"♥️"
                                                                       rank:@13];
        FISPlayingCard *myInvalidPlayingCard = [[FISPlayingCard alloc] initWithSuit:@"♥️"
                                                                         rank:@14];
    ...
    describe(@"valid suit with with designated initializer", ^{
        ...
        beforeAll(^{
            myValidPlayingCard = [[FISPlayingCard alloc] initWithSuit:@"♥️" rank:@13];
